...
const source = {
  ...
  "externalActivities": {
    "sourceStatus": "AUTHORITATIVE",
    "title": "외부 활동 & 연계",
    "introduction": "키움증권, 한국투자증권 등 주요 증권사와 파트너십을 맺고 있으며, 2025년 KB증권 '월가를 향한 흑백 마스터' 대회에서 우승을 차지했습니다. 다양한 대외 네트워크를 통해 회원들의 성장을 지원하고 있습니다.",
    "items": [
      {
        "id": "korea-investment",
        "label": "한국투자증권",
  ...
  "activitySections": [
    {
      ...
      "pageDetails": [
        ...
        },
        {
          "id": "weekly-deadline",
          "title": "주간 이슈 정리",
          "description": "한 주간의 섹터 이슈와 관련 종목을 조사하고 핵심 내용을 정리해 발표합니다."
        },
        {
          "id": "one-question",
          "title": "인사이트 공유",
          "description": "발표 후 질문과 의견을 나누며 서로의 관점을 확장하고, 이슈에 대한 투자 생각을 구체화합니다."
        }
      ]
    },
    {
